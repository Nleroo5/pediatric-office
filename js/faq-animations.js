/**
 * Giraffe Animation Controller for Patient Portalpage
...
class GiraffeAnimations {
    ...
    createGiraffeElement() {
        ...
        this.giraffe.innerHTML = `
            ...
            <div class="giraffe-spotlight"></div>
        ...
        style.textContent = `
            ...
            @media (min-width: 769px) {
                .giraffe-animation:hover .text-bubble {
                    opacity: 1;
    ...
    hideAnimal() {
        ...
        this.giraffe.style.right = '-250px';
        this.giraffe.classList.remove('giraffe-visible');
    }
    ...
    bindEvents() {
        ...
        if (window.innerWidth >= 769) {
            this.giraffe.addEventListener('mouseenter', () => {
                if (!bubbleActivated) {
                    const bubble = this.giraffe.querySelector('.text-bubble');
                    if (bubble) {
...
// Only initialize giraffe animations on patient portal page
